...
def main(args=None):
	...
	parser.add_argument('--jinnan_path',help='Path to JinNan directory')
	...
	if parser.dataset == 'coco':
		...
		dataset_val = JinNanDataset(parser.jinnan_path, set_name='val', transform=transforms.Compose([Normalizer(), Resizer()]))
	else:
